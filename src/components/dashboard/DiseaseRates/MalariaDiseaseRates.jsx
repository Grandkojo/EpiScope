...
export const MalariaDiseaseRates = ({ dashboardDataRegionRates, isDashboardDataRegionRatesLoading, isDashboardDataRegionRatesError, selectedDisease, selectedDiseaseYear }) => {
