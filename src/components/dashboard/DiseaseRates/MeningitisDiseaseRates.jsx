...
export const MeningitisDiseaseRates = ({ dashboardDataRegionRates, isDashboardDataRegionRatesLoading, isDashboardDataRegionRatesError, selectedDisease, selectedDiseaseYear }) => {
