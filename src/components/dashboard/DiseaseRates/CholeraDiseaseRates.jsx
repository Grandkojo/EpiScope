...
export const CholeraDiseaseRates = ({ dashboardDataRegionRates, isDashboardDataRegionRatesLoading, isDashboardDataRegionRatesError, selectedDisease, selectedDiseaseYear }) => {
